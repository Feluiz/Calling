...
import Gatalog from "./Gatalog/Gatalog";
...
const Cats = () => {
  ...
  const SetColors = () => {
    setGatalogBtn(
      gatalogBtn === "bg-transparent" ? "bg-orange-500" : "bg-transparent"
    );
    setVoteBtn(
      voteBtn === "bg-orange-500" ? "bg-transparent" : "bg-orange-500"
    );
  ...
  return (
    <div className="flex flex-col items-center mt-16 mb-10">
      ...
      <div className="flex flex-row mt-20">
        <button
          className={`mx-5 border-2 p-2 rounded-lg w-24 ${gatalogBtn}`}
          onClick={() => SetColors()}
        >
          Gatalog
        </button>
        <button
          className={`mx-5 border-2 p-2 rounded-lg w-24 ${voteBtn}`}
          onClick={() => SetColors()}
        >
          Voting
        </button>
